...
.method public g(Landroid/util/AttributeSet;)V
    ...
    invoke-static {v0, p1, v1}, Lj/t1;->t(Landroid/content/Context;Landroid/util/AttributeSet;[I)Lj/t1;
    ...
    invoke-virtual {p1, v0, v1}, Lj/t1;->m(II)I
    ...
    invoke-virtual {p1, v0, v2}, Lj/t1;->j(II)I
    ...
    invoke-virtual {p1, v2, v3}, Lj/t1;->j(II)I
    ...
    invoke-virtual {p1, v0}, Lj/t1;->o(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1, v0}, Lj/t1;->n(I)Ljava/lang/String;
    ...
    invoke-virtual {p1, v0}, Lj/t1;->r(I)Z

    move-result v2

    if-eqz v2, :cond_0

    invoke-virtual {p1, v0, v1}, Lj/t1;->a(IZ)Z
    ...
    invoke-virtual {p1, v0, v2}, Lj/t1;->a(IZ)Z
    ...
    invoke-virtual {p0, v0, v3, v5}, Lh/g$b;->e(Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Ld0/b;

    iput-object v0, p0, Lh/g$b;->A:Ld0/b;
    ...
    :cond_3
    iput-object v4, p0, Lh/g$b;->A:Ld0/b;
    ...
    invoke-virtual {p1, v0}, Lj/t1;->c(I)Landroid/content/res/ColorStateList;
...
.method public final i(Landroid/view/MenuItem;)V
    ...
    :cond_8
    :goto_3
    iget-object v0, p0, Lh/g$b;->A:Ld0/b;

    if-eqz v0, :cond_9

    invoke-static {p1, v0}, Ld0/p;->a(Landroid/view/MenuItem;Ld0/b;)Landroid/view/MenuItem;

    :cond_9
    iget-object v0, p0, Lh/g$b;->B:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Ld0/p;->c(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lh/g$b;->C:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Ld0/p;->g(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-char v0, p0, Lh/g$b;->n:C

    iget v1, p0, Lh/g$b;->o:I

    invoke-static {p1, v0, v1}, Ld0/p;->b(Landroid/view/MenuItem;CI)V

    iget-char v0, p0, Lh/g$b;->p:C

    iget v1, p0, Lh/g$b;->q:I

    invoke-static {p1, v0, v1}, Ld0/p;->f(Landroid/view/MenuItem;CI)V

    iget-object v0, p0, Lh/g$b;->E:Landroid/graphics/PorterDuff$Mode;

    if-eqz v0, :cond_a

    invoke-static {p1, v0}, Ld0/p;->e(Landroid/view/MenuItem;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v0}, Ld0/p;->d(Landroid/view/MenuItem;Landroid/content/res/ColorStateList;)V
