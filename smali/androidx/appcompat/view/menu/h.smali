...
.method public final a()Li/d;
    ...
    invoke-static {v0, v1}, Li/e;->a(Landroid/view/Display;Landroid/graphics/Point;)V
    ...
    invoke-virtual {v0, v1}, Li/d;->k(Landroidx/appcompat/view/menu/e;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/h;->l:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v1}, Li/d;->t(Landroid/widget/PopupWindow$OnDismissListener;)V
    ...
    invoke-virtual {v0, v1}, Li/d;->q(Z)V

    iget v1, p0, Landroidx/appcompat/view/menu/h;->g:I

    invoke-virtual {v0, v1}, Li/d;->r(I)V
...
.method public g(Z)V
    ...
    invoke-virtual {v0, p1}, Li/d;->q(Z)V
...
.method public final l(IIZZ)V
    ...
    invoke-virtual {v0, p4}, Li/d;->u(Z)V
    ...
    invoke-static {p4}, Ld0/s0;->n(Landroid/view/View;)I
    ...
    :cond_0
    invoke-virtual {v0, p1}, Li/d;->s(I)V

    invoke-virtual {v0, p2}, Li/d;->v(I)V
    ...
    invoke-virtual {v0, p4}, Li/d;->p(Landroid/graphics/Rect;)V

    :cond_1
    invoke-interface {v0}, Li/g;->show()V
