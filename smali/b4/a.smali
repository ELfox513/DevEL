...
.method public a(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    invoke-virtual/range {v1 .. v7}, Lb4/a;->e(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZ)Z
...
.method public c(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    invoke-static {p2}, Lb4/a;->f(Landroid/content/ServiceConnection;)Z
    ...
    invoke-static {p1, v0}, Lb4/a;->g(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object p1, p0, Lb4/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_0
    invoke-static {p1, p2}, Lb4/a;->g(Landroid/content/Context;Landroid/content/ServiceConnection;)V
...
.method public final d(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    invoke-virtual/range {v0 .. v6}, Lb4/a;->e(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZ)Z
...
.method public final e(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZ)Z
    ...
    invoke-virtual {v2, p6, v1}, Ld4/d;->c(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_1
    :goto_0
    invoke-static {p4}, Lb4/a;->f(Landroid/content/ServiceConnection;)Z

    move-result p6

    if-eqz p6, :cond_4

    iget-object p6, p0, Lb4/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p2, p0, Lb4/a;->a:Ljava/util/concurrent/ConcurrentHashMap;
