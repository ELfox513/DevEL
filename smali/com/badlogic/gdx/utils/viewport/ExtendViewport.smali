...
.field public m:Lcom/badlogic/gdx/utils/Scaling;
...
.method public constructor <init>(FFFFLcom/badlogic/gdx/graphics/Camera;)V
    ...
    iput-object v0, p0, Lcom/badlogic/gdx/utils/viewport/ExtendViewport;->m:Lcom/badlogic/gdx/utils/Scaling;

    iput p1, p0, Lcom/badlogic/gdx/utils/viewport/ExtendViewport;->i:F

    iput p2, p0, Lcom/badlogic/gdx/utils/viewport/ExtendViewport;->j:F

    iput p3, p0, Lcom/badlogic/gdx/utils/viewport/ExtendViewport;->k:F

    iput p4, p0, Lcom/badlogic/gdx/utils/viewport/ExtendViewport;->l:F
...
.method public getMaxWorldHeight()F
    ...
    iget v0, p0, Lcom/badlogic/gdx/utils/viewport/ExtendViewport;->l:F
...
.method public getMaxWorldWidth()F
    ...
    iget v0, p0, Lcom/badlogic/gdx/utils/viewport/ExtendViewport;->k:F
...
.method public getMinWorldHeight()F
    ...
    iget v0, p0, Lcom/badlogic/gdx/utils/viewport/ExtendViewport;->j:F
...
.method public getMinWorldWidth()F
    ...
    iget v0, p0, Lcom/badlogic/gdx/utils/viewport/ExtendViewport;->i:F
...
.method public setMaxWorldHeight(F)V
    ...
    iput p1, p0, Lcom/badlogic/gdx/utils/viewport/ExtendViewport;->l:F
...
.method public setMaxWorldWidth(F)V
    ...
    iput p1, p0, Lcom/badlogic/gdx/utils/viewport/ExtendViewport;->k:F
...
.method public setMinWorldHeight(F)V
    ...
    iput p1, p0, Lcom/badlogic/gdx/utils/viewport/ExtendViewport;->j:F
...
.method public setScaling(Lcom/badlogic/gdx/utils/Scaling;)V
    ...
    iput-object p1, p0, Lcom/badlogic/gdx/utils/viewport/ExtendViewport;->m:Lcom/badlogic/gdx/utils/Scaling;
...
.method public update(IIZ)V
    ...
    iget v1, p0, Lcom/badlogic/gdx/utils/viewport/ExtendViewport;->j:F

    iget-object v2, p0, Lcom/badlogic/gdx/utils/viewport/ExtendViewport;->m:Lcom/badlogic/gdx/utils/Scaling;
    ...
    iget v5, p0, Lcom/badlogic/gdx/utils/viewport/ExtendViewport;->k:F

    cmpl-float v8, v5, v4

    if-lez v8, :cond_0

    iget v8, p0, Lcom/badlogic/gdx/utils/viewport/ExtendViewport;->i:F
    ...
    iget v5, p0, Lcom/badlogic/gdx/utils/viewport/ExtendViewport;->l:F

    cmpl-float v4, v5, v4

    if-lez v4, :cond_2

    iget v4, p0, Lcom/badlogic/gdx/utils/viewport/ExtendViewport;->j:F
