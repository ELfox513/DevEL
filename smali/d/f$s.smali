...
.method public constructor <init>(I)V
    ...
    iput p1, p0, Ld/f$s;->a:I

    const/4 p1, 0x0

    iput-boolean p1, p0, Ld/f$s;->q:Z
...
.method public a(Landroidx/appcompat/view/menu/i$a;)Landroidx/appcompat/view/menu/j;
    ...
    iget-object v0, p0, Ld/f$s;->j:Landroidx/appcompat/view/menu/e;
    ...
    :cond_0
    iget-object v0, p0, Ld/f$s;->k:Landroidx/appcompat/view/menu/c;

    if-nez v0, :cond_1

    new-instance v0, Landroidx/appcompat/view/menu/c;

    iget-object v1, p0, Ld/f$s;->l:Landroid/content/Context;

    sget v2, Lc/g;->j:I

    invoke-direct {v0, v1, v2}, Landroidx/appcompat/view/menu/c;-><init>(Landroid/content/Context;I)V

    iput-object v0, p0, Ld/f$s;->k:Landroidx/appcompat/view/menu/c;

    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/c;->g(Landroidx/appcompat/view/menu/i$a;)V

    iget-object p1, p0, Ld/f$s;->j:Landroidx/appcompat/view/menu/e;
    ...
    :cond_1
    iget-object p1, p0, Ld/f$s;->k:Landroidx/appcompat/view/menu/c;

    iget-object v0, p0, Ld/f$s;->g:Landroid/view/ViewGroup;
...
.method public b()Z
    ...
    iget-object v0, p0, Ld/f$s;->h:Landroid/view/View;
    ...
    :cond_0
    iget-object v0, p0, Ld/f$s;->i:Landroid/view/View;
...
.method public c(Landroidx/appcompat/view/menu/e;)V
    ...
    iget-object v1, p0, Ld/f$s;->k:Landroidx/appcompat/view/menu/c;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/e;->O(Landroidx/appcompat/view/menu/i;)V

    :cond_1
    iput-object p1, p0, Ld/f$s;->j:Landroidx/appcompat/view/menu/e;
...
.method public d(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Ld/f$s;->l:Landroid/content/Context;
