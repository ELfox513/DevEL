...
.method public final s(Ljava/lang/String;)Lr4/ed0;
    ...
    invoke-static {v0}, Lr4/dd0;->f7(Landroid/os/IBinder;)Lr4/ed0;
...
.method public final u(Ljava/lang/String;)Lr4/ib0;
    ...
    instance-of v2, v1, Lr4/ib0;

    if-eqz v2, :cond_1

    move-object v0, v1

    check-cast v0, Lr4/ib0;

    goto :goto_0

    :cond_1
    new-instance v1, Lr4/gb0;

    invoke-direct {v1, v0}, Lr4/gb0;-><init>(Landroid/os/IBinder;)V
