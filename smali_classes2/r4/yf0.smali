...
.method public final h0()Lr4/gg0;
    .locals 1
...
.method public final bridge synthetic r(Landroid/os/IBinder;)Landroid/os/IInterface;
    ...
    instance-of v1, v0, Lr4/gg0;

    if-eqz v1, :cond_1

    move-object p1, v0

    check-cast p1, Lr4/gg0;

    goto :goto_0

    :cond_1
    new-instance v0, Lr4/dg0;

    invoke-direct {v0, p1}, Lr4/dg0;-><init>(Landroid/os/IBinder;)V
