.class Lcom/prineside/tdi2/serializers/IntFloatMapSerializer$3;
...
# virtual methods
.method public compare(Lcom/badlogic/gdx/utils/IntFloatMap;Lcom/badlogic/gdx/utils/IntFloatMap;Lcom/badlogic/gdx/utils/StringBuilder;Lcom/badlogic/gdx/utils/Array;ILcom/badlogic/gdx/utils/IntIntMap;Z)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget p5, p1, Lcom/badlogic/gdx/utils/IntFloatMap;->size:I

    iget p6, p2, Lcom/badlogic/gdx/utils/IntFloatMap;->size:I
    ...
    iget p6, p1, Lcom/badlogic/gdx/utils/IntFloatMap;->size:I
    ...
    :cond_1
    invoke-virtual {p1}, Lcom/badlogic/gdx/utils/IntFloatMap;->iterator()Ljava/util/Iterator;
    ...
    check-cast p5, Lcom/badlogic/gdx/utils/IntFloatMap$Entry;

    iget p6, p5, Lcom/badlogic/gdx/utils/IntFloatMap$Entry;->key:I

    invoke-virtual {p2, p6}, Lcom/badlogic/gdx/utils/IntFloatMap;->containsKey(I)Z
    ...
    iget p5, p5, Lcom/badlogic/gdx/utils/IntFloatMap$Entry;->key:I
    ...
    :cond_4
    iget p6, p5, Lcom/badlogic/gdx/utils/IntFloatMap$Entry;->value:F

    iget v3, p5, Lcom/badlogic/gdx/utils/IntFloatMap$Entry;->key:I

    const/4 v4, 0x0

    invoke-virtual {p2, v3, v4}, Lcom/badlogic/gdx/utils/IntFloatMap;->get(IF)F
    ...
    iget v2, p5, Lcom/badlogic/gdx/utils/IntFloatMap$Entry;->key:I
    ...
    iget v2, p5, Lcom/badlogic/gdx/utils/IntFloatMap$Entry;->value:F

    invoke-virtual {p6, v2}, Lcom/badlogic/gdx/utils/StringBuilder;->append(F)Lcom/badlogic/gdx/utils/StringBuilder;
    ...
    invoke-virtual {p2, p5, v4}, Lcom/badlogic/gdx/utils/IntFloatMap;->get(IF)F

    move-result p5

    invoke-virtual {p6, p5}, Lcom/badlogic/gdx/utils/StringBuilder;->append(F)Lcom/badlogic/gdx/utils/StringBuilder;
...
.method public bridge synthetic compare(Ljava/lang/Object;Ljava/lang/Object;Lcom/badlogic/gdx/utils/StringBuilder;Lcom/badlogic/gdx/utils/Array;ILcom/badlogic/gdx/utils/IntIntMap;Z)V
    ...
    invoke-virtual/range {p0 .. p7}, Lcom/prineside/tdi2/serializers/IntFloatMapSerializer$3;->compare(Lcom/badlogic/gdx/utils/IntFloatMap;Lcom/badlogic/gdx/utils/IntFloatMap;Lcom/badlogic/gdx/utils/StringBuilder;Lcom/badlogic/gdx/utils/Array;ILcom/badlogic/gdx/utils/IntIntMap;Z)V
