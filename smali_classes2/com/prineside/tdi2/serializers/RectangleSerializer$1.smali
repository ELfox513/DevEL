.class Lcom/prineside/tdi2/serializers/RectangleSerializer$1;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/prineside/tdi2/serializers/RectangleSerializer;
.end annotation
...
# virtual methods
.method public compare(Lcom/badlogic/gdx/math/Rectangle;Lcom/badlogic/gdx/math/Rectangle;Lcom/badlogic/gdx/utils/StringBuilder;Lcom/badlogic/gdx/utils/Array;ILcom/badlogic/gdx/utils/IntIntMap;Z)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget p5, p1, Lcom/badlogic/gdx/math/Rectangle;->x:F

    iget p6, p2, Lcom/badlogic/gdx/math/Rectangle;->x:F

    cmpl-float p5, p5, p6

    if-nez p5, :cond_0

    iget p5, p1, Lcom/badlogic/gdx/math/Rectangle;->y:F

    iget p6, p2, Lcom/badlogic/gdx/math/Rectangle;->y:F

    cmpl-float p5, p5, p6

    if-nez p5, :cond_0

    iget p5, p1, Lcom/badlogic/gdx/math/Rectangle;->width:F

    iget p6, p2, Lcom/badlogic/gdx/math/Rectangle;->width:F

    cmpl-float p5, p5, p6

    if-nez p5, :cond_0

    iget p5, p1, Lcom/badlogic/gdx/math/Rectangle;->height:F

    iget p6, p2, Lcom/badlogic/gdx/math/Rectangle;->height:F
    ...
    iget p5, p2, Lcom/badlogic/gdx/math/Rectangle;->x:F
    ...
    iget p5, p2, Lcom/badlogic/gdx/math/Rectangle;->y:F
    ...
    :cond_3
    iget p4, p1, Lcom/badlogic/gdx/math/Rectangle;->width:F
    ...
    :cond_4
    iget p4, p1, Lcom/badlogic/gdx/math/Rectangle;->height:F

    iget p5, p2, Lcom/badlogic/gdx/math/Rectangle;->height:F
...
.method public bridge synthetic compare(Ljava/lang/Object;Ljava/lang/Object;Lcom/badlogic/gdx/utils/StringBuilder;Lcom/badlogic/gdx/utils/Array;ILcom/badlogic/gdx/utils/IntIntMap;Z)V
    ...
    invoke-virtual/range {p0 .. p7}, Lcom/prineside/tdi2/serializers/RectangleSerializer$1;->compare(Lcom/badlogic/gdx/math/Rectangle;Lcom/badlogic/gdx/math/Rectangle;Lcom/badlogic/gdx/utils/StringBuilder;Lcom/badlogic/gdx/utils/Array;ILcom/badlogic/gdx/utils/IntIntMap;Z)V
