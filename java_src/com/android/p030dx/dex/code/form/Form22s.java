...
public final class Form22s extends InsnFormat {
    ...
    public String insnCommentString(DalvInsn dalvInsn, boolean z) {
        return InsnFormat.literalBitsComment((AbstractC7234v) ((CstInsn) dalvInsn).getConstant(), 16);
    }
    ...
    public boolean isCompatible(DalvInsn dalvInsn) {
        ...
        if (!abstractC7234v.mo2058x() || !InsnFormat.signedFitsInShort(abstractC7234v.mo2057z())) {
            return false;
        }
        return true;
    }
    ...
    public void writeTo(InterfaceC0428a interfaceC0428a, DalvInsn dalvInsn) {
        C7160r registers = dalvInsn.getRegisters();
        InsnFormat.write(interfaceC0428a, InsnFormat.opcodeUnit(dalvInsn, InsnFormat.makeByte(registers.m2347A(0).m2380B(), registers.m2347A(1).m2380B())), (short) ((AbstractC7234v) ((CstInsn) dalvInsn).getConstant()).mo2057z());
    }
}
