...
public final class Form21s extends InsnFormat {
    ...
    public void writeTo(InterfaceC0428a interfaceC0428a, DalvInsn dalvInsn) {
        InsnFormat.write(interfaceC0428a, InsnFormat.opcodeUnit(dalvInsn, dalvInsn.getRegisters().m2347A(0).m2380B()), (short) ((AbstractC7234v) ((CstInsn) dalvInsn).getConstant()).mo2057z());
    }
}
