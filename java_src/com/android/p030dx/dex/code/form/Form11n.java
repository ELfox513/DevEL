...
public final class Form11n extends InsnFormat {
    ...
    public String insnCommentString(DalvInsn dalvInsn, boolean z) {
        return InsnFormat.literalBitsComment((AbstractC7234v) ((CstInsn) dalvInsn).getConstant(), 4);
    }
    ...
    public boolean isCompatible(DalvInsn dalvInsn) {
        C7160r registers = dalvInsn.getRegisters();
        if (!(dalvInsn instanceof CstInsn) || registers.size() != 1 || !InsnFormat.unsignedFitsInNibble(registers.m2347A(0).m2380B())) {
            return false;
        }
        ...
        if (!abstractC7234v.mo2058x() || !InsnFormat.signedFitsInNibble(abstractC7234v.mo2057z())) {
            return false;
        }
        return true;
    }
    ...
    public void writeTo(InterfaceC0428a interfaceC0428a, DalvInsn dalvInsn) {
        InsnFormat.write(interfaceC0428a, InsnFormat.opcodeUnit(dalvInsn, InsnFormat.makeByte(dalvInsn.getRegisters().m2347A(0).m2380B(), ((AbstractC7234v) ((CstInsn) dalvInsn).getConstant()).mo2057z() & 15)));
    }
}
