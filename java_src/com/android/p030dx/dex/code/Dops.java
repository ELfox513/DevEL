...
import com.android.p030dx.dex.code.form.Form10t;
import com.android.p030dx.dex.code.form.Form10x;
import com.android.p030dx.dex.code.form.Form11n;
import com.android.p030dx.dex.code.form.Form11x;
import com.android.p030dx.dex.code.form.Form12x;
import com.android.p030dx.dex.code.form.Form20t;
import com.android.p030dx.dex.code.form.Form21c;
import com.android.p030dx.dex.code.form.Form21h;
import com.android.p030dx.dex.code.form.Form21s;
import com.android.p030dx.dex.code.form.Form21t;
import com.android.p030dx.dex.code.form.Form22b;
import com.android.p030dx.dex.code.form.Form22c;
import com.android.p030dx.dex.code.form.Form22s;
import com.android.p030dx.dex.code.form.Form22t;
import com.android.p030dx.dex.code.form.Form22x;
import com.android.p030dx.dex.code.form.Form23x;
import com.android.p030dx.dex.code.form.Form30t;
import com.android.p030dx.dex.code.form.Form31c;
import com.android.p030dx.dex.code.form.Form31i;
import com.android.p030dx.dex.code.form.Form31t;
import com.android.p030dx.dex.code.form.Form32x;
import com.android.p030dx.dex.code.form.Form35c;
import com.android.p030dx.dex.code.form.Form3rc;
import com.android.p030dx.dex.code.form.Form45cc;
import com.android.p030dx.dex.code.form.Form4rcc;
import com.android.p030dx.dex.code.form.Form51l;
import com.android.p030dx.dex.code.form.SpecialFormat;
...
public final class Dops {
    ...
    static {
        ...
        Dop dop193 = new Dop(HttpStatus.SC_OK, 168, 168, insnFormat2, true);
        MUL_FLOAT_2ADDR = dop193;
        Dop dop194 = new Dop(HttpStatus.SC_CREATED, 169, 169, insnFormat2, true);
        DIV_FLOAT_2ADDR = dop194;
        Dop dop195 = new Dop(HttpStatus.SC_ACCEPTED, 170, 170, insnFormat2, true);
        REM_FLOAT_2ADDR = dop195;
        Dop dop196 = new Dop(HttpStatus.SC_NON_AUTHORITATIVE_INFORMATION, 171, 171, insnFormat2, true);
        ADD_DOUBLE_2ADDR = dop196;
        Dop dop197 = new Dop(HttpStatus.SC_NO_CONTENT, 172, 172, insnFormat2, true);
        SUB_DOUBLE_2ADDR = dop197;
        Dop dop198 = new Dop(HttpStatus.SC_RESET_CONTENT, 173, 173, insnFormat2, true);
        MUL_DOUBLE_2ADDR = dop198;
        Dop dop199 = new Dop(HttpStatus.SC_PARTIAL_CONTENT, 174, 174, insnFormat2, true);
        DIV_DOUBLE_2ADDR = dop199;
        Dop dop200 = new Dop(HttpStatus.SC_MULTI_STATUS, 175, 175, insnFormat2, true);
