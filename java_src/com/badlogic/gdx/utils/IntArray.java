...
public class IntArray {
    ...
    public void add(int i) {
        ...
        int i2 = this.size;
        if (i2 == iArr.length) {
            iArr = m23652a(Math.max(8, (int) (i2 * 1.75f)));
        }
        int i3 = this.size;
        this.size = i3 + 1;
        iArr[i3] = i;
    ...
    public int[] ensureCapacity(int i) {
        if (i >= 0) {
            ...
            if (i2 > this.items.length) {
                m23652a(Math.max(Math.max(8, i2), (int) (this.size * 1.75f)));
            }
            return this.items;
        }
    ...
    public void insert(int i, int i2) {
        ...
        if (i <= i3) {
            int[] iArr = this.items;
            if (i3 == iArr.length) {
                iArr = m23652a(Math.max(8, (int) (i3 * 1.75f)));
            }
            if (this.ordered) {
    ...
    public void insertRange(int i, int i2) {
        ...
        if (i <= i3) {
            ...
            if (i4 > this.items.length) {
                this.items = m23652a(Math.max(Math.max(8, i4), (int) (this.size * 1.75f)));
            }
            int[] iArr = this.items;
            System.arraycopy(iArr, i, iArr, i2 + i, this.size - i);
            this.size = i4;
            return;
        }
        throw new IndexOutOfBoundsException("index can't be > size: " + i + " > " + this.size);
    ...
    public void addAll(int[] iArr, int i, int i2) {
        ...
        int i3 = this.size + i2;
        if (i3 > iArr2.length) {
            iArr2 = m23652a(Math.max(Math.max(8, i3), (int) (this.size * 1.75f)));
        }
    ...
    public void add(int i, int i2, int i3) {
        ...
        int i4 = this.size;
        if (i4 + 2 >= iArr.length) {
            iArr = m23652a(Math.max(8, (int) (i4 * 1.75f)));
        }
        int i5 = this.size;
        iArr[i5] = i;
        iArr[i5 + 1] = i2;
    ...
    public void add(int i, int i2, int i3, int i4) {
        ...
        int i5 = this.size;
        if (i5 + 3 >= iArr.length) {
            iArr = m23652a(Math.max(8, (int) (i5 * 1.8f)));
        }
        int i6 = this.size;
        iArr[i6] = i;
        iArr[i6 + 1] = i2;
