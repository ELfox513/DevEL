...
public abstract class FieldAccess {
    ...
    /* renamed from: d */
    public static final IdentityMap<Class<?>, FieldAccess> f8391d = new IdentityMap<>();
    ...
    /* renamed from: a */
    public static void m22225a(ClassWriter classWriter) {
    ...
    /* renamed from: b */
    public static void m22224b(ClassWriter classWriter, String str, ArrayList<Field> arrayList) {
        int i;
    ...
    /* renamed from: e */
    public static void m22221e(ClassWriter classWriter, String str, ArrayList<Field> arrayList) {
        int i;
        ...
        MethodVisitor m22219g = m22219g(visitMethod);
        m22219g.visitMaxs(i, 4);
        m22219g.visitEnd();
    }
    ...
    /* renamed from: c */
    public static void m22223c(ClassWriter classWriter, String str, ArrayList<Field> arrayList, Type type) {
        String str2;
        int i;
        ...
        if (!arrayList.isEmpty()) {
            ...
            if (z) {
                visitMethod.visitLabel(label);
                visitMethod.visitFrame(3, 0, null, 0, null);
                m22218h(visitMethod, type.getClassName());
            }
        ...
        MethodVisitor m22219g = m22219g(visitMethod);
        m22219g.visitMaxs(i, 3);
        m22219g.visitEnd();
    }

    /* renamed from: d */
    public static void m22222d(ClassWriter classWriter, String str, ArrayList<Field> arrayList) {
        int i;
    ...
    */
    public static void m22220f(com.esotericsoftware.asm.ClassWriter r22, java.lang.String r23, java.util.ArrayList<java.lang.reflect.Field> r24, com.esotericsoftware.asm.Type r25) {
        /*
            Method dump skipped, instructions count: 346
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.prineside.reflectasm.FieldAccess.m22220f(com.esotericsoftware.asm.ClassWriter, java.lang.String, java.util.ArrayList, com.esotericsoftware.asm.Type):void");
    }

    /* renamed from: g */
    public static MethodVisitor m22219g(MethodVisitor methodVisitor) {
    ...
    public static FieldAccess get(Class cls) {
        ...
        FieldAccess fieldAccess = f8391d.get(cls);
        if (fieldAccess != null) {
            return fieldAccess;
        }
        if (cls.getSuperclass() != null) {
            ...
            synchronized (m22232d) {
                ...
                if (m22229g == null) {
                    ...
                    classWriter.visit(50, 4129, replace, null, "com/prineside/reflectasm/FieldAccess", null);
                    m22225a(classWriter);
                    m22224b(classWriter, replace2, arrayList);
                    m22221e(classWriter, replace2, arrayList);
                    Type type = Type.BOOLEAN_TYPE;
                    m22223c(classWriter, replace2, arrayList, type);
                    m22220f(classWriter, replace2, arrayList, type);
                    Type type2 = Type.BYTE_TYPE;
                    m22223c(classWriter, replace2, arrayList, type2);
                    m22220f(classWriter, replace2, arrayList, type2);
                    Type type3 = Type.SHORT_TYPE;
                    m22223c(classWriter, replace2, arrayList, type3);
                    m22220f(classWriter, replace2, arrayList, type3);
                    Type type4 = Type.INT_TYPE;
                    m22223c(classWriter, replace2, arrayList, type4);
                    m22220f(classWriter, replace2, arrayList, type4);
                    Type type5 = Type.LONG_TYPE;
                    m22223c(classWriter, replace2, arrayList, type5);
                    m22220f(classWriter, replace2, arrayList, type5);
                    Type type6 = Type.DOUBLE_TYPE;
                    m22223c(classWriter, replace2, arrayList, type6);
                    m22220f(classWriter, replace2, arrayList, type6);
                    Type type7 = Type.FLOAT_TYPE;
                    m22223c(classWriter, replace2, arrayList, type7);
                    m22220f(classWriter, replace2, arrayList, type7);
                    Type type8 = Type.CHAR_TYPE;
                    m22223c(classWriter, replace2, arrayList, type8);
                    m22220f(classWriter, replace2, arrayList, type8);
                    m22222d(classWriter, replace2, arrayList);
                    classWriter.visitEnd();
                    m22229g = m22232d.m22234b(str, classWriter.toByteArray());
                }
            }
            try {
                FieldAccess fieldAccess2 = (FieldAccess) m22229g.newInstance();
                fieldAccess2.f8392a = strArr;
                fieldAccess2.f8393b = clsArr;
                fieldAccess2.f8394c = (Field[]) arrayList.toArray(new Field[arrayList.size()]);
                f8391d.put(cls, fieldAccess2);
                return fieldAccess2;
            } catch (Throwable th) {
    ...
    /* renamed from: h */
    public static MethodVisitor m22218h(MethodVisitor methodVisitor, String str) {
        methodVisitor.visitTypeInsn(187, "java/lang/IllegalArgumentException");
        methodVisitor.visitInsn(89);
        methodVisitor.visitTypeInsn(187, "java/lang/StringBuilder");
        methodVisitor.visitInsn(89);
