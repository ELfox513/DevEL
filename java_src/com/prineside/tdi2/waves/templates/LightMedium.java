...
public class LightMedium extends WaveTemplates.WaveTemplate {
    ...
    /* renamed from: a */
    public final WaveTemplates.EnemyGroupConfig[] f15279a = {new WaveTemplates.EnemyGroupConfig() { // from class: com.prineside.tdi2.waves.templates.LightMedium.1
        /* renamed from: a */
        public final float m19714a(int i) {
            return MathUtils.clamp(((i / 15.0f) * 0.6f) + 0.4f, 0.0f, 1.0f);
        }

        /* renamed from: b */
        public final float m19713b(int i) {
            return 1.0f / m19714a(i);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getBounty(int i, float f, float f2) {
            return ((i * 0.05f) + 2.0f) * m19713b(i);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public int getCount(int i, float f, float f2) {
            return (int) ((((int) StrictMath.pow(i, 0.65d)) + 12) * m19714a(i));
        }
    ...
    public int getProbability(int i, float f, float f2) {
        return WaveTemplates.calculateProbability(i, f2, 3, 0.06f, 0.5f, 0.23f, 25.0f, 20.0f, 0.03f, 7);
    }
