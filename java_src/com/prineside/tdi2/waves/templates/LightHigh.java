...
public class LightHigh extends WaveTemplates.WaveTemplate {
    ...
    /* renamed from: a */
    public final WaveTemplates.EnemyGroupConfig[] f15277a = {new WaveTemplates.EnemyGroupConfig() { // from class: com.prineside.tdi2.waves.templates.LightHigh.1
        /* renamed from: a */
        public final float m19716a(int i) {
            return MathUtils.clamp(((i / 20.0f) * 0.6f) + 0.4f, 0.0f, 1.0f);
        }

        /* renamed from: b */
        public final float m19715b(int i) {
            return 1.0f / m19716a(i);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getBounty(int i, float f, float f2) {
            return ((i * 0.04f) + 1.5f) * m19715b(i);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public int getCount(int i, float f, float f2) {
            return (int) ((((int) StrictMath.pow(i, 0.7d)) + 16) * m19716a(i));
        }
    ...
    public int getProbability(int i, float f, float f2) {
        return WaveTemplates.calculateProbability(i, f2, 3, 0.07f, 0.35f, 0.36f, -34.0f, 25.0f, 0.035f, 6);
    }
