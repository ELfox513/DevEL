...
public class HealerIcy extends WaveTemplates.WaveTemplate {
    ...
    /* renamed from: a */
    public final WaveTemplates.EnemyGroupConfig[] f15251a = {new WaveTemplates.EnemyGroupConfig() { // from class: com.prineside.tdi2.waves.templates.HealerIcy.1
        /* renamed from: a */
        public final float m19748a(int i) {
            return MathUtils.clamp(((i / 25.0f) * 0.4f) + 0.6f, 0.0f, 1.0f);
        }

        /* renamed from: b */
        public final float m19747b(int i) {
            return 1.0f / m19748a(i);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getBounty(int i, float f, float f2) {
            return ((i * 0.035f) + 1.3f) * m19747b(i);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public int getCount(int i, float f, float f2) {
            return (int) ((((int) StrictMath.pow(i * 0.95f, 0.6d)) + 9) * m19748a(i));
        }
        ...
        public float getInterval(int i, float f, float f2) {
            return m19747b(i) * 0.67f;
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getKillExp(int i, float f, float f2) {
            return ((i * 0.007f) + 0.7f) * m19747b(i);
        }
    ...
    }, new WaveTemplates.EnemyGroupConfig() { // from class: com.prineside.tdi2.waves.templates.HealerIcy.2
        /* renamed from: a */
        public final float m19746a(int i) {
            return MathUtils.clamp(((i / 25.0f) * 0.4f) + 0.6f, 0.0f, 1.0f);
        }

        /* renamed from: b */
        public final float m19745b(int i) {
            return 1.0f / m19746a(i);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getBounty(int i, float f, float f2) {
            return ((i * 0.075f) + 2.5f) * m19745b(i);
        }
        ...
        public int getCount(int i, float f, float f2) {
            ...
            Double.isNaN(pow);
            double m19746a = m19746a(i);
            Double.isNaN(m19746a);
            return (int) (pow * 0.8d * m19746a);
        }
        ...
        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getInterval(int i, float f, float f2) {
            return m19745b(i) * 1.1f;
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getKillExp(int i, float f, float f2) {
            return ((i * 0.012f) + 1.2f) * m19745b(i);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public int getKillScore(int i, float f, float f2) {
            return (int) (m19745b(i) * 15.0f);
        }
    ...
    public int getProbability(int i, float f, float f2) {
        return WaveTemplates.calculateProbability(i, f2, 3, 0.05f, 0.65f, 0.2f, -10.0f, 28.0f, 0.1f, 4);
    }
