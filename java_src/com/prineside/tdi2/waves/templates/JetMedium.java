...
public class JetMedium extends WaveTemplates.WaveTemplate {
    ...
    /* renamed from: a */
    public final WaveTemplates.EnemyGroupConfig[] f15272a = {new WaveTemplates.EnemyGroupConfig() { // from class: com.prineside.tdi2.waves.templates.JetMedium.1
        /* renamed from: a */
        public final float m19722a(int i) {
            return MathUtils.clamp(((i / 20.0f) * 0.5f) + 0.5f, 0.0f, 1.0f);
        }

        /* renamed from: b */
        public final float m19721b(int i) {
            return 1.0f / m19722a(i);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getBounty(int i, float f, float f2) {
            return ((i * 0.15f) + 5.25f) * m19721b(i);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public int getCount(int i, float f, float f2) {
            return (int) ((((int) StrictMath.pow(i, 0.58d)) + 6) * 0.6f * m19722a(i));
        }
    ...
    public int getProbability(int i, float f, float f2) {
        return WaveTemplates.calculateProbability(i, f2, 5, 0.07f, 0.25f, 0.22f, 25.0f, 22.0f, 0.085f, 3);
    }
