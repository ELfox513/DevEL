...
public class HealerStrong extends WaveTemplates.WaveTemplate {
    ...
    /* renamed from: a */
    public final WaveTemplates.EnemyGroupConfig[] f15262a = {new WaveTemplates.EnemyGroupConfig() { // from class: com.prineside.tdi2.waves.templates.HealerStrong.1
        /* renamed from: a */
        public final float m19734a(int i) {
            return MathUtils.clamp(((i / 20.0f) * 0.6f) + 0.4f, 0.0f, 1.0f);
        }

        /* renamed from: b */
        public final float m19733b(int i) {
            return 1.0f / m19734a(i);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getBounty(int i, float f, float f2) {
            return ((i * 0.075f) + 2.75f) * m19733b(i);
        }
        ...
        public int getCount(int i, float f, float f2) {
            double d;
            Double.isNaN(i);
            return (int) ((((int) StrictMath.pow(d * 0.8d, 0.53d)) + 4) * m19734a(i));
        }
    ...
    }, new WaveTemplates.EnemyGroupConfig() { // from class: com.prineside.tdi2.waves.templates.HealerStrong.2
        /* renamed from: a */
        public final float m19732a(int i) {
            return MathUtils.clamp(((i / 25.0f) * 0.4f) + 0.6f, 0.0f, 1.0f);
        }

        /* renamed from: b */
        public final float m19731b(int i) {
            return 1.0f / m19732a(i);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getBounty(int i, float f, float f2) {
            return ((i * 0.075f) + 2.5f) * m19731b(i);
        }
        ...
        public int getCount(int i, float f, float f2) {
            ...
            Double.isNaN(pow);
            double m19732a = m19732a(i);
            Double.isNaN(m19732a);
            return (int) (pow * 0.8d * m19732a);
        }
        ...
        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getInterval(int i, float f, float f2) {
            return m19731b(i) * 1.1f;
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getKillExp(int i, float f, float f2) {
            return ((i * 0.012f) + 1.2f) * m19731b(i);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public int getKillScore(int i, float f, float f2) {
            return (int) (m19731b(i) * 15.0f);
        }
