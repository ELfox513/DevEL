...
public class FastMedium extends WaveTemplates.WaveTemplate {

    /* renamed from: a */
    public final WaveTemplates.EnemyGroupConfig[] f15239a = {new WaveTemplates.EnemyGroupConfig() { // from class: com.prineside.tdi2.waves.templates.FastMedium.1
        /* renamed from: a */
        public final float m19762a(int i) {
            return MathUtils.clamp(((i / 15.0f) * 0.6f) + 0.4f, 0.0f, 1.0f);
        }

        /* renamed from: b */
        public final float m19761b(int i) {
            return 1.0f / m19762a(i);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getBounty(int i, float f, float f2) {
            return ((i * 0.05f) + 2.0f) * m19761b(i);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public int getCount(int i, float f, float f2) {
            return (int) ((((int) StrictMath.pow(i, 0.65d)) + 12) * m19762a(i));
        }
    ...
    public int getProbability(int i, float f, float f2) {
        return WaveTemplates.calculateProbability(i, f2, 3, 0.06f, 0.5f, 0.22f, -65.0f, 40.0f, 0.11f, 7);
    }
