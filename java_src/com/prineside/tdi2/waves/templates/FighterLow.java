...
public class FighterLow extends WaveTemplates.WaveTemplate {
    ...
    /* renamed from: a */
    public final WaveTemplates.EnemyGroupConfig[] f15244a = {new WaveTemplates.EnemyGroupConfig() { // from class: com.prineside.tdi2.waves.templates.FighterLow.1
        /* renamed from: a */
        public final float m19756a(int i) {
            return MathUtils.clamp(((i / 20.0f) * 0.6f) + 0.4f, 0.0f, 1.0f);
        }

        /* renamed from: b */
        public final float m19755b(int i) {
            return 1.0f / m19756a(i);
        }

        @Override // com.prineside.tdi2.WaveTemplates.EnemyGroupConfig
        public float getBounty(int i, float f, float f2) {
            return ((i * 0.105f) + 5.5f) * m19755b(i);
        }
        ...
        public int getCount(int i, float f, float f2) {
            double d;
            Double.isNaN(i);
            double pow = (((int) StrictMath.pow(d * 0.9d, 0.59d)) + 4) * m19756a(i);
            Double.isNaN(pow);
            return (int) (pow * 0.8d);
        }
