    ...
    */
    ...
    public ResourcePackBitmapFont getFont(int i, boolean z) {
        if (this.f8865b) {
            ...
            ResourcePackBitmapFont resourcePackBitmapFont = new ResourcePackBitmapFont(this.f8864a ? Gdx.files.external(this.f8866d) : Gdx.files.external(this.f8866d), array, false);
