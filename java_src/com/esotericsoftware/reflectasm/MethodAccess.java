...
public abstract class MethodAccess {
    ...
    public int getIndex(String str) {
        int length = this.f7611a.length;
        for (int i = 0; i < length; i++) {
            if (this.f7611a[i].equals(str)) {
                return i;
            }
        }
    ...
    public static MethodAccess get(Class cls) {
        ...
        if (!isInterface) {
            for (Class cls2 = cls; cls2 != Object.class; cls2 = cls2.getSuperclass()) {
                m23106a(cls2, arrayList);
            }
        } else {
            m23105b(cls, arrayList);
        }
        ...
        synchronized (m23121d) {
            ...
            if (m23118g == null) {
                ...
                str3 = str;
                m23118g = m23121d.m23123b(str3, classWriter.toByteArray());
            } else {
                clsArr = clsArr5;
                clsArr2 = clsArr6;
            }
        ...
        try {
            MethodAccess methodAccess = (MethodAccess) m23118g.newInstance();
            methodAccess.f7611a = strArr;
            methodAccess.f7612b = clsArr;
            methodAccess.f7613c = clsArr2;
            return methodAccess;
        } catch (Throwable th) {
    ...
    /* renamed from: a */
    public static void m23106a(Class cls, ArrayList<Method> arrayList) {
    ...
    /* renamed from: b */
    public static void m23105b(Class cls, ArrayList<Method> arrayList) {
        m23106a(cls, arrayList);
        for (Class<?> cls2 : cls.getInterfaces()) {
            m23105b(cls2, arrayList);
        }
    }
    ...
    public int getIndex(String str, Class... clsArr) {
        int length = this.f7611a.length;
        for (int i = 0; i < length; i++) {
            if (this.f7611a[i].equals(str) && Arrays.equals(clsArr, this.f7612b[i])) {
                return i;
            }
        }
    ...
    public int getIndex(String str, int i) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            if (this.f7611a[i2].equals(str) && this.f7612b[i2].length == i) {
                return i2;
            }
        }
