...
public final class HashingSource extends ForwardingSource {
    ...
    public long read(Buffer buffer, long j) {
        ...
        if (read != -1) {
            ...
            while (j2 < buffer.f19734b) {
                int i = (int) ((segment.f19762b + j3) - j2);
                MessageDigest messageDigest = this.messageDigest;
                if (messageDigest != null) {
                    messageDigest.update(segment.f19761a, i, segment.f19763c - i);
                } else {
                    this.mac.update(segment.f19761a, i, segment.f19763c - i);
                }
                j3 = (segment.f19763c - segment.f19762b) + j2;
