...
import p083i0.C4082a;
import p083i0.C4083b;
import p083i0.C4084c;
/* renamed from: u0.d */
/* loaded from: classes.dex */
public class C6837d {
    /* renamed from: b */
    public static Interpolator m3280b(Context context, int i) {
        ...
        try {
            try {
                ...
                Interpolator m3281a = m3281a(context, context.getResources(), context.getTheme(), animation);
                if (animation != null) {
                    animation.close();
                }
                return m3281a;
    ...
    */
    public static android.view.animation.Interpolator m3281a(android.content.Context r2, android.content.res.Resources r3, android.content.res.Resources.Theme r4, org.xmlpull.v1.XmlPullParser r5) {
        /*
            int r3 = r5.getDepth()
            r4 = 0
        L5:
        ...
        Lca:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: p191u0.C6837d.m3281a(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser):android.view.animation.Interpolator");
    }
}
