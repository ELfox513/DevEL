...
public final class C4030f extends C6896d {
    @RecentlyNonNull
    /* renamed from: a */
    public static String m17518a(int i) {
        if (i != 26540) {
            if (i != 26541) {
                switch (i) {
                    case 26502:
    ...
    @RecentlyNonNull
    /* renamed from: b */
    public static Status m17517b(int i) {
        return new Status(4, m17518a(4));
    }

    @RecentlyNonNull
    /* renamed from: c */
    public static Status m17516c(int i, @RecentlyNonNull PendingIntent pendingIntent) {
        return new Status(i, m17518a(i), pendingIntent);
    }
}
